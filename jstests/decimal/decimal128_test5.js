(function() {
    ...
    var testData = [
        ...
        {
          "description":
              "[decq090] underflows cannot be tested for simple copies, check edge cases (Subnormal)",
          "input": "1e-6176",
          "expected": "1E-6176"
        },
        {
          "description":
              "[decq100] underflows cannot be tested for simple copies, check edge cases (Subnormal)",
